    ...
    private void showError(@NonNull DownloadMission mission) {
        ...
        switch (mission.errCode) {
            ...
            case DownloadMission.ERROR_CONNECT_HOST:
                ...
                break;
            case DownloadMission.ERROR_POSTPROCESSING_STOPPED:
                msg = R.string.error_postprocessing_stopped;
                break;
            case DownloadMission.ERROR_POSTPROCESSING:
            case DownloadMission.ERROR_POSTPROCESSING_HOLD:
                showError(mission.errObject, UserAction.DOWNLOAD_POSTPROCESSING, R.string.error_postprocessing_failed);
                return;
            case DownloadMission.ERROR_INSUFFICIENT_STORAGE:
            ...
            case DownloadMission.ERROR_UNKNOWN_EXCEPTION:
                ...
                return;
            case DownloadMission.ERROR_PROGRESS_LOST:
                msg = R.string.error_progress_lost;
                break;
            case DownloadMission.ERROR_TIMEOUT:
